...
public class CostomLinkedList<T> 
...
public CostomLinkedList<Integer> getValue() {

	MyNode<T> tmp = first;
	CostomLinkedList<Integer> MyNode=new CostomLinkedList<Integer>();
	while (true) {
		if (tmp == null) {
			break;
		}
...
public boolean printValue(int length, String key, CostomLinkedList<String> li) {
	MyNode<T> nd2 = first;
	while (true) {
		if (nd2 == null) {
			break;
...
public void remove(int index){
   ...
   public int [] convInteger(CostomLinkedList<Integer> li,int len)
{
...
public boolean findIntegerValue(int length, int key, CostomLinkedList<Integer> li2) {
	MyNode<T> nd2 = first;
	while (true) {
		if (nd2 == null) {
			break;
...
public String [] convString(CostomLinkedList<T> li,int len)
{
...
public int [] convertInt(CostomLinkedList<Integer> li,int len)
{
	MyNode<Integer> nd2 = li.first;
	int [] str=new int[len];
	int i=0;
